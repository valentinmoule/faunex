CREATE OR REPLACE FUNCTION public.category_leaderboard(p_category text, p_limit integer DEFAULT 20, p_scope text DEFAULT 'global'::text)
...
CREATE OR REPLACE FUNCTION public.my_category_rank(p_category text, p_scope text DEFAULT 'global'::text)
