...
import { Search, Lock, Bell, CheckCircle, PawPrint, Bird, Fish, Bug, Turtle, Rabbit, Shell, Waves, ChevronDown, MapPin, List, Map as MapIcon, type LucideIcon } from 'lucide-react';
