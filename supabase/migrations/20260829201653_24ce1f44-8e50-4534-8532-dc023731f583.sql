...
DROP FUNCTION IF EXISTS public.my_category_rank(text);
...
REVOKE ALL ON FUNCTION public.category_leaderboard(text, integer, text) FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.my_category_rank(text, text) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.category_leaderboard(text, integer, text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.my_category_rank(text, text) TO authenticated;
