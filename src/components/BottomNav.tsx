...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-card/90 backdrop-blur-xl border-t border-border safe-bottom" style={{ position: '-webkit-sticky' as any, position: 'fixed', WebkitTransform: 'translateZ(0)' }}>
